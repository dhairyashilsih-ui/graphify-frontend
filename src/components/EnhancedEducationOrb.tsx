...
interface EnhancedEducationOrbProps {
  isActive?: boolean;
  image?: string;
}

export default function EnhancedEducationOrb({ isActive = false, image }: EnhancedEducationOrbProps) {
  return (
    <div className="relative flex items-center justify-center w-72 h-72 mx-auto">
      ...
      <motion.div
        ...
        className="absolute inset-4 rounded-full bg-gradient-to-br from-blue-300/40 via-purple-400/30 to-cyan-400/40 blur-xl"
      />
      ...
      <motion.div
        ...
        className="relative z-10 w-52 h-52 rounded-full bg-gradient-to-br from-blue-400 via-purple-500 to-cyan-500 shadow-2xl overflow-hidden border-2 border-white/20"
        style={{
          boxShadow: '0 0 60px rgba(59, 130, 246, 0.6), inset 0 0 60px rgba(255, 255, 255, 0.1)',
        }}
      >
        {/* Premium Inner Gradient Layer */}
        <div className="absolute inset-0 rounded-full bg-gradient-to-br from-white/30 via-transparent to-blue-600/20" />
        ...
        <motion.div
          ...
          style={{
            boxShadow: 'inset 0 0 30px rgba(255, 255, 255, 0.2), 0 0 20px rgba(59, 130, 246, 0.3)',
          }}
        >
          {image ? (
            <motion.img
              src={image}
              alt="Education Intelligence"
        ...
        {isActive && (
          <>
            <motion.div
              ...
              className="absolute inset-0 rounded-full border-2 border-blue-300/80"
            />
            <motion.div
