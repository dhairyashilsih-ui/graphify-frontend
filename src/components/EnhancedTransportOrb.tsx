...
interface EnhancedTransportOrbProps {
  isActive?: boolean;
  image?: string;
}

export default function EnhancedTransportOrb({ isActive = false, image }: EnhancedTransportOrbProps) {
  return (
    <div className="relative flex items-center justify-center w-72 h-72 mx-auto">
      ...
      <motion.div
        ...
        style={{
          background: 'conic-gradient(from 0deg, #06b6d4, #0ea5e9, #3b82f6, #06b6d4)',
          filter: 'blur(3px)',
        }}
      />
      ...
      <motion.div
        ...
        className="absolute inset-4 rounded-full bg-gradient-to-br from-cyan-300/40 via-blue-400/30 to-sky-400/40 blur-xl"
      />
      ...
      <motion.div
        ...
        className="relative z-10 w-52 h-52 rounded-full bg-gradient-to-br from-cyan-400 via-blue-500 to-sky-500 shadow-2xl overflow-hidden border-2 border-white/20"
        style={{
          boxShadow: '0 0 60px rgba(6, 182, 212, 0.6), inset 0 0 60px rgba(255, 255, 255, 0.1)',
        }}
      >
        {/* Premium Inner Gradient Layer */}
        <div className="absolute inset-0 rounded-full bg-gradient-to-br from-white/30 via-transparent to-cyan-600/20" />
        ...
        <motion.div
          ...
          style={{
            boxShadow: 'inset 0 0 30px rgba(255, 255, 255, 0.2), 0 0 20px rgba(6, 182, 212, 0.3)',
          }}
        >
          {image ? (
            <motion.img
              src={image}
              alt="Transport Intelligence"
